...
public class DefaultRequestService implements RequestService {
     ...
     *
     * @param personalDetail The {@link PersonalDetailsDTO} object to be sent.
     ...
     */
    public boolean sendDetailsToEndpoint(final PersonalDetailsDTO personalDetail) {
     ...
     *
     * @param personalDetail The {@link PersonalDetailsDTO} object that was saved.
     * @param response       The HTTP response received from the server.
     */
    private void logCreatedMessage(final PersonalDetailsDTO personalDetail, final ClientHttpResponse response) {
        log.info("The record for customer ref {} has successfully been saved to the database",
                personalDetail.customerRef());
    }
}